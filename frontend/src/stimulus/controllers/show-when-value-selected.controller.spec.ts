...
describe('OpShowWhenValueSelectedController', () => {
  ...
  describe('initial render on connect', () => {
    it('shows the effect matching the preselected value without a change event', async () => {
      await ctx.mount(`
        <div data-controller="show-when-value-selected">
          <select data-show-when-value-selected-target="cause"
                  data-target-name="type"
            ...
            <option value="">-- Select --</option>
            <option value="a">Type A</option>
            <option value="b" selected>Type B</option>
          </select>
          <input type="text"
                 data-show-when-value-selected-target="effect"
                 data-target-name="type"
    ...
    it('keeps a data-not-value effect hidden when the preselected value matches not-value', async () => {
      await ctx.mount(`
        <div data-controller="show-when-value-selected">
          <select data-show-when-value-selected-target="cause"
    ...
    it('shows a data-not-value effect when the preselected value does not match not-value', async () => {
      await ctx.mount(`
        <div data-controller="show-when-value-selected">
          <select data-show-when-value-selected-target="cause"
                  data-target-name="mode"
